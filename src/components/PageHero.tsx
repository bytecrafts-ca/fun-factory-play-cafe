  ...
  return (
    ...
    >
      <div className="container-main grid items-center gap-10 py-14 sm:py-20 lg:grid-cols-2 lg:gap-14">
        <div className={aside ? "lg:order-1" : ""}>
        ...
        <div className={`space-y-5 ${aside ? "lg:order-2" : ""}`}>
          <div
          ...
          >
            <div className="relative aspect-[5/4] sm:aspect-[4/3]">
              ...
              />
              <div
                className="pointer-events-none absolute inset-0 bg-gradient-to-t from-charcoal/15 via-transparent to-transparent"
                aria-hidden
              />
            </div>
          </div>
