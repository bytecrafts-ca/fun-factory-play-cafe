import { IconClipboard, IconCoffee, IconEye, IconParking, IconShield, IconSocks } from "@/components/Icons";
...
const items = [
  ...
  { icon: IconCoffee, label: "Snacks & Drinks Available", bg: "bg-peach/40" },
  { icon: IconParking, label: "Free Parking", bg: "bg-sunshine/40" },
];
  ...
  return (
    <section className="border-b border-peach/40 bg-white">
      <div className="container-main">
        <ul className="grid grid-cols-2 divide-x divide-y divide-peach/30 sm:grid-cols-3 lg:grid-cols-6 lg:divide-y-0">
