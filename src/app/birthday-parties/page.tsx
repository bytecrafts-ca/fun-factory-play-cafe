    ...
    segments: [
      {
        type: "text",
        value:
          "Parties run for 2.5 hours with four slots daily per room. Pizza is served 30 minutes after the party starts, except for morning parties where pizza is served at 11:15 am. Cake is served 30 minutes after pizza. See the party timelines section above for the full schedule.",
      },
    ],
  },
];
